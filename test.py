...
'''
  ...
  Runs all tests found in the current directory and all its subdirectories. All
  files ending with '_test.py' are considered tests. Run
    ./test.py
