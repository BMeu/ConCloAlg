...
class TestNode(unittest.TestCase):
  ...
  def test_init(self):
    ...
    self.assertEqual(node1.parents, set([node2]))
  ...
  def test_add_single_parent(self):
    ...
    self.assertEqual(node1.parents, set([node2, node3]))
  ...
  def test_get_class_representative(self):
    ...
    # Without setting anything else, all nodes are their own representatives.
  ...
  def test_get_class_parents(self):
    ...
    self.assertEqual(node1.get_class_parents(), set([node2]))
    self.assertEqual(node2.get_class_parents(), set())
    self.assertEqual(node3.get_class_parents(), set([node4]))
    ...
    node4.find = node3
    self.assertEqual(node1.get_class_parents(), set([node2]))
    self.assertEqual(node2.get_class_parents(), set([node2]))
    self.assertEqual(node3.get_class_parents(), set([node4]))
    self.assertEqual(node4.get_class_parents(), set([node4]))

    node3.find = node1
    self.assertEqual(node1.get_class_parents(), set([node2]))
    self.assertEqual(node2.get_class_parents(), set([node2]))
    self.assertEqual(node3.get_class_parents(), set([node2]))
    self.assertEqual(node4.get_class_parents(), set([node2]))
  ...
  def test_union(self):
    ...
    node4.union(node1)
    self.assertEqual(node1.parents, set())
    self.assertEqual(node2.parents, set([node1, node3, node4]))
    self.assertEqual(node3.parents, set())
  ...
  def test_add_argument(self):
    ...
    self.assertEqual(node1.parents, set([node3]))
    self.assertEqual(node2.parents, set([node1]))
    self.assertEqual(node3.parents, set())
    self.assertEqual(node4.parents, set())
    self.assertEqual(node5.parents, set([node4]))
